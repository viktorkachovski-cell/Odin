...
export const bg: Record<TranslationKey, string> = {
  ...
  'list.actions': 'Действия за списъка',
  'list.delete': 'Изтрий списъка',
  'list.delete.title': 'Да изтрия ли този списък?',
  ...
  'task.actions': 'Действия за {title}',
  'task.delete': 'Изтрий {title}',
  'task.delete.short': 'Изтрий',
  'task.delete.title': 'Да изтрия ли тази задача?',
  'task.delete.confirm': 'Изтрий задачата окончателно?',
  'task.unassign': 'Премахни възложителя на {title}',
  'task.unassign.short': 'Премахни възложителя',
  'task.unassign.title': 'Да премахна ли изпълнителя?',
  'task.unassign.confirm': 'Премахни текущия възложител?',
